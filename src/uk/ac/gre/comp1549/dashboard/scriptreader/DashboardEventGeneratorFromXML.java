...
public class DashboardEventGeneratorFromXML extends DefaultHandler {
     ...
     */
    public static int delayUnits = 100; // 1000 = 1 second
     ...
     */
    public DashboardEventGeneratorFromXML(int delayunits) throws Exception {
 ...
 populated with data by the character() method
    ...
    public static void main(String[] args) throws Exception {
        ...
        DashboardEventGeneratorFromXML me = new DashboardEventGeneratorFromXML(100);
